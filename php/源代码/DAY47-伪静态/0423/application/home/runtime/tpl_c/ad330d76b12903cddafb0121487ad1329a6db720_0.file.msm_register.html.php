<?php
/* Smarty version 3.1.30, created on 2017-04-20 10:34:15
  from "D:\tnwamp\apache\htdocs\0420\application\home\view\user\msm_register.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58f81e27d1f7e6_76293890',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ad330d76b12903cddafb0121487ad1329a6db720' => 
    array (
      0 => 'D:\\tnwamp\\apache\\htdocs\\0420\\application\\home\\view\\user\\msm_register.html',
      1 => 1492655652,
      2 => 'file',
    ),
  ),
...
function content_58f81e27d1f7e6_76293890 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
...
home/css/default/img/login_logo.png"></a>
	...
	<div class="mod-body">
		<form method="post" action="?c=user&a=sendMessageAction">
			<ul>
				<li>
					<input type="text" value="" name="phone" placeholder="请输入手机号码" class="aw-register-email form-control">
					<span style="float:right"><input type="submit" value="点击发送验证码"></span>
				</li>
				<li class="aw-register-verify">
					<img src="?m=home&c=user&a=makeCaptchaAction" onclick="this.src='?m=home&c=user&a=createCaptcha&'"+Math.random()+"" id="captcha" class="pull-right">
